    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 mx-auto">
            <h4 class="mb-3">{{ $product['c_name'] }}</h4>
        </div>
      </div>
    </div>
...
@section('content')
    ...
    <section class="section-sm py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ asset($product['img_thumbnail']) }}" class="img-fluid rounded-0" alt="{{ $product['name'] }}">
                </div>
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-baseline">
                        <p class="price-sale mr-1" style="color: red; font-size: 1.5rem;">${{ $product['price_sale'] }}</p>
                        <p class="price-regular me-3" style="font-size: 1.2rem; text-decoration: line-through;">${{ $product['price_regular'] }}</p>
                    </div>

                    <p class="overview mt-3">{!! $product['overview'] !!}</p>
