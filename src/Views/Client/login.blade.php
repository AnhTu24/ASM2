...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center mt-5"> <!-- Thêm lớp justify-content-center để căn giữa -->
            <form class="col-lg-6" action="{{ url('handle-login') }}" method="POST">
                <!-- Điều chỉnh cỡ form bằng lớp col-lg-6 -->
                <div class="mb-3 mt-3">
            ...
            <a href="{{ url('register') }}"><p>Chưa có tài khoản? <span>Đăng ký</span></p></a>
