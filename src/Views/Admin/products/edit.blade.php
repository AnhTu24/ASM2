                    ...
                    <div class="box_header m-0">
                        <form action="{{ url("admin/products/{$product['id']}/update") }}" enctype="multipart/form-data"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" id="price_regular"
                                            placeholder="Enter regular price" value="{{ $product['price_regular'] }}"
                                            name="price_regular">
                                    </div>
                                    <div class="mb-3 mt-3">
                                        <label for="price_sale" class="form-label">Price Sale:</label>
                                        <input type="text" class="form-control" id="price_sale"
                                            placeholder="Enter sale price" value="{{ $product['price_sale'] }}"
                                            name="price_sale">
                                    </div>
                            ...
                            <div class='d-flex gap-2'>
                                ...
                                <button type="button" class="btn btn-primary" onclick="history.go(-2)">Back</button>
                            </div>
                        </form>
                    </div>
                </div>
